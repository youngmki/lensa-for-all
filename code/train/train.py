...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        # default=None,
        default=os.environ.get("SM_CHANNEL_TRAINING"),  # newly added
        # required=True,
        required=False,  # newly added
    ...
    parser.add_argument(
        ...
        default=os.environ.get("SM_MODEL_DIR"),  # newly added
    ...
    parser.add_argument(  # newly added
        "--wandb_api_key",
        type=str,
        default=None,
        help="Your API key when using the wandb tracker.",
    )
    ...
    if args.with_prior_preservation:
        args.class_data_dir = f"{args.instance_data_dir}/class_data_dir"  # newly added
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.instance_images_path = list(
            ...
            if "class_data_dir" not in path.stem
        )  # newly added
...
def main(args):
    ...
    if accelerator.is_main_process:
        if args.report_to == "wandb" and args.wandb_api_key is not None:  # newly added
